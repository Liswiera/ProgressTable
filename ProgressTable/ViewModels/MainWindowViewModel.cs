...
namespace ProgressTable.ViewModels
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        public MainWindowViewModel()
        {
            ...
            {
                new Student{Name="Бояркин Вадим Дмитриевич", Visual=0, Architecture=0, Networks=0, Calculate_Math=2, PI=2, Math=2, Electric=1},
                new Student{Name="Чероченко Дарья Андреевна", Visual=0, Architecture=1, Networks=2, Calculate_Math=2, PI=1, Math=2, Electric=2},
                new Student{Name="Михайленко Егор Андреевич", Visual=1, Architecture=2, Networks=2, Calculate_Math=1, PI=2, Math=1, Electric=2},
            };
            CheckAverage(students);
        }
